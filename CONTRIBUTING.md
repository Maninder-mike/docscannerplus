...
The following is a set of guidelines for contributing to DocScanner+. These are just guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
- Run `flutter format .` before committing changes.
